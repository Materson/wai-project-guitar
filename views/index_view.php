	...
	<body>
		<div id="container">
			...
			<section>
				Skocz do:
				<ul class="akapity">
					<li><a href="#ak1">akapit 1</a></li>
					<li><a href="#ak2">akapit 2</a></li>
					<li><a href="#ak3">akapit 3</a></li>
					<li><a href="#ak4">akapit 4</a></li>
					<li><a href="#ak5">akapit 5</a></li>
					<li><a href="#ak6">akapit 6</a></li>
					<li><a href="#ak7">akapit 7</a></li>
					<li><a href="#ak8">akapit 8</a></li>
				</ul>
				<article>
					<h2>Krótko o gitarze</h2>
					<p id="ak1">
				...
				<button onclick="addNewP()">Dodaj nowy akapit</button>
				<p>
					Treści zaczerpnięte ze strony <a href="https://www.infomusic.pl/poradnik/4750,ciekawostki-historia-gitary">https://www.infomusic.pl/poradnik/4750,ciekawostki-historia-gitary</a>
				</p>				
			</section>
		</div>
